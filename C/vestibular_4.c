...
int main() {
    ...
    float current_note_participant = 0.0;
    ...
    for (int i = 0; i < int_quantify_participants; i++) {
        ...
        printf("Insira a nota do %s.\n", current_name_participant);
        ...
        if (current_note_participant > 5) {
            quantify_participants_higher_achievement_half += 1;
        }
